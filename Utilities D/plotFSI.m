...
%
%   INPUTS:
%       FSI_italy, FSI_spain, FSI_euro - Struct arrays containing monthly FSI states.
%       dates_BTP, dates_BON           - Vectors of evaluation datenums.
%       spread10y_BTP, spread10y_BON   - Vectors of 10-year benchmark spreads.
%       spreadName                     - (Optional) String for plot titles 
%                                        (default is 'ASW', useful for 'Zeta').
