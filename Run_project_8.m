...
% Part C.3: Save results
fprintf('=== PART C: Saving broken-line results ===\n');
save('Part_C.mat', 'tau_star_BTP', 'L_star_BTP', 'dates_BTP', ...
                   'tau_star_BON', 'L_star_BON', 'dates_BON');
fprintf('Saved to Part_C.mat\n');
